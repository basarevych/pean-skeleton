...
describe('/v1/users route', function () {
    var config;
    ...
    it('describes table', function (done) {
        ...
        request(app)
            .get('/v1/users/table?query=describe')
    ...
    it('renders table', function (done) {
        ...
        request(app)
            .get('/v1/users/table?query=data&filters={}&sort_column="id"&sort_dir="asc"&page_number=1&page_size=0')
            .expect('Content-Type', /json/)
            .expect(function (res) {
                expect(aclQueried).toBeTruthy();
                expect(res.body.success).toBeTruthy();
